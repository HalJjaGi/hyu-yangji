...
class CampusMapSimpleScreen extends StatefulWidget {
  const CampusMapSimpleScreen({super.key});

  @override
  State<CampusMapSimpleScreen> createState() => _CampusMapSimpleScreenState();
}

class _CampusMapSimpleScreenState extends State<CampusMapSimpleScreen> {
  @override
