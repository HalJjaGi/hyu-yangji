...
class _NaverMapScreenState extends State<NaverMapScreen> {
  ...
  String _getNaverMapHtml() {
    ...
    // .env 파일에서 가져온 네이버 API 키
    const naverClientId = 'pctubllds4';
...
<head>
    ...
    <script type="text/javascript" src="https://oapi.map.naver.com/openapi/v3/maps.js?ncpClientId=$naverClientId"></script>
    <style>
        * {
            margin: 0;
            padding: 0;
